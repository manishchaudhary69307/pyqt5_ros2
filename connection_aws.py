...
# 🔑 CONFIGURATION: Replace with your actual paths and endpoint
...
CERT_FILEPATH = "aws_certificates/device_certificate.pem.crt"
...
mqtt_conn = mqtt_connection_builder.mtls_from_path(
    ...
    on_connection_resumed=lambda conn, rc, sess: print("🔁 Connection resumed")
)
